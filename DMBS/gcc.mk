...
DMBS_BUILD_TARGETS         += size symbol-sizes all lib elf bin hex lss clean mostlyclean test
...
test:
	...
	gcc $(CC_FLAGS) $(TEST_TARGET) $(SRC) -o AllTests
...
.PHONY: build_begin build_end size symbol-sizes lib elf hex lss clean mostlyclean test
